...
# ============================================================
# INSTRUCTIONS:
# 1. Upload fixed_l19_dev_outputs.json to Google Drive: MyDrive/dsar_phase11/
# 2. In Colab run:
#    !pip install semgrep
#    from google.colab import drive; drive.mount('/content/drive')
#    !python colab_scan_phase11.py
# 3. Download fixed_l19_dev_icd.json back to outputs/phase11/
# ============================================================
...
def main():
    ...
    scan_file(DRIVE_DIR / "fixed_l19_dev_outputs.json", DRIVE_DIR / "fixed_l19_dev_icd.json")
    print("\nDone. Download fixed_l19_dev_icd.json to outputs/phase11/")
